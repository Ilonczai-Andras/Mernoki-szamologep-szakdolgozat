...
class Ui_MainWindow(object):
    ...
    def generateKalkulus(self):
        ...
        self.window.setWindowIcon(QIcon('C:/Sources/Mernoki-szamologep-szakdolgozat/Engineering calculator/icon.ico'))  # Ensure this path is correct
        self.window.show()
...
if __name__ == "__main__":
    ...
    MainWindow.setWindowIcon(QIcon('C:/Sources/Mernoki-szamologep-szakdolgozat/Engineering calculator/icon.ico'))  # Ensure this path is correct
    MainWindow.show()
    sys.exit(app.exec_())

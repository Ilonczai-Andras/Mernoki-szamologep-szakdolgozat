...
import os
from Pyqt5Helper import Pyqt5Helper
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        helper = Pyqt5Helper("path/to/icon.png")

        comboBox = helper.create_combobox(MainWindow)
        comboBox.setFont(font)
        
        helper.generate_window(comboBox, MainWindow)  # Pass MainWindow as needed
